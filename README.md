...
동일 타입 이벤트는 `dispatcher.cooldown_s`(30초) 동안 재 dispatch 안 됨.

## 진행 상황

- [x] 1: 웹캠 + YOLOv8n 렌더 루프 (2026-04-23 확인)
- [x] 2 재구성: 얼굴 미탐 + ROI 이탈 2규칙 (v0)
- [x] 2 v1: pose + cause 분기 + 판정 안정화
- [x] 3: YAMNet 울음 감지 + person AND 조건 (v2)
- [ ] 4: 서버 연동
- [ ] 5: 통합 테스트·튜닝
- [ ] 6: 데모 준비
